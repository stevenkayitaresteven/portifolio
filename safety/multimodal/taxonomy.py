...
_GENERIC: dict[str, str | None] = {
    **{c: c for c in CATEGORIES},
    ...
    "identity_hate": HATE, "racism": HATE, "racist": HATE,
    "sexism": HATE, "sexist": HATE,
    "abuse": TOXIC, "abusive": TOXIC, "offensive": TOXIC,
    "bullying": TOXIC, "cyberbullying": TOXIC, "profane": TOXIC,
